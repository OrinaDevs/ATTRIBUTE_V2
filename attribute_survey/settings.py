...
ROOT_URLCONF = 'attribute_survey.urls'
...
WSGI_APPLICATION = 'attribute_survey.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'Attribute Land Survey <surveyattribute@gmail.com>'
EMAIL_TIMEOUT = 10
